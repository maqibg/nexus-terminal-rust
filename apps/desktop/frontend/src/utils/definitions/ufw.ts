 ...
 */
const ufwStatus: CommandDefinition = {
    name: 'status',
    description: '查看状态',
    options: [
...
const ufwAllow: CommandDefinition = {
    name: 'allow',
    description: '允许端口',
    options: [
...
const ufwDeny: CommandDefinition = {
    name: 'deny',
    description: '拒绝端口',
    options: [
        { text: '22', type: 'hint', description: 'SSH', priority: 100 },
...
const ufwDefault: CommandDefinition = {
    name: 'default',
    description: '默认策略',
    options: [
...
const ufwLogging: CommandDefinition = {
    name: 'logging',
    description: '日志设置',
    options: [
...
const ufwEnable: CommandDefinition = {
    name: 'enable',
    description: '启用防火墙',
    options: [],
};

const ufwDisable: CommandDefinition = {
    name: 'disable',
    description: '禁用防火墙',
    options: [],
};

const ufwReset: CommandDefinition = {
    name: 'reset',
    description: '重置防火墙',
    options: [
        { text: '--force', type: 'option', description: '强制执行', priority: 90 },
    ],
};

const ufwReload: CommandDefinition = {
    name: 'reload',
    description: '重载规则',
    options: [],
};

const ufwDelete: CommandDefinition = {
    name: 'delete',
    description: '删除规则',
    options: [
        { text: 'allow', type: 'subcommand', description: '删除 allow 规则', priority: 90, usage: 'ufw delete allow 22' },
        { text: 'deny', type: 'subcommand', description: '删除 deny 规则', priority: 85, usage: 'ufw delete deny 3306' },
    ],
    subcommands: {
        allow: ufwAllow,
        deny: ufwDeny,
